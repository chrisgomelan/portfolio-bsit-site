...
import { ArrowRight, Code2, Copy, Code, Zap } from "lucide-react";
    ...
    <div
      ...
      <div
        ...
        <div
          ...
          {/* Bottom content */}
          <div className="absolute right-0 bottom-0 left-0 p-5 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-sm">
          ...
          <div className="relative z-10 flex-1 space-y-5">
            ...
            <div className="space-y-2.5">
              {features.map((feature, index) => {
                const icons = [Copy, Code2, Code, Zap];
